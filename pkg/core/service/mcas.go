...
func GetMcas(namespace string) (model.McasStatus, error) {
...
func GetMcas(namespace, name, version string) (*model.Package, error) {
	common.CBLog.Debugf("[CALLED]")
